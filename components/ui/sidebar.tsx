      ...
      >      
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            {Autos.map((item) => {
  return ( 
    <SidebarLinkGroup key={item.value} open={segments.includes(item.value)}>
      {(handleClick, open) => {
        return (
          <>
            <a
            ...
            <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
              ...
              {item.options.map((sub) => {
                return (
                  <li key={sub.value} className="mb-1 last:mb-0">
                  <SidebarLink href={`${item.value}/${sub.value}`}>
