  ...
  return (
    ...
    <div className="hidden sm:flex sm:auto-cols-max justify-start sm:justify-end gap-2 relative w-full sm:w-fit z-10">
      <div className="flex gap-8 w-full sm:w-fit justify-center items-center bg-red-800 text-white px-6 sm:absolute sm:top-0 sm:right-0 sm:rounded-es-3xl text-sm font-medium py-2">
        <div className="flex justify-center items-center gap-2 text-nowrap"><FaPhoneAlt /> 0800 777 7368</div>
        <div className="flex justify-center items-center gap-2 text-nowrap"><FaLocationDot /> San Lorenzo 370</div>
        <div className="flex justify-center items-center gap-2 text-nowrap"><MdGTranslate /><span className="hidden md:block">In english</span></div>
        <ThemeToggle />
      </div>
    </div>
    <BurgerMenu />
