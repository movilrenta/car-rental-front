...
import OrdersTable from "@/app/[locale]/(default)/ecommerce/orders/orders-table"
...
export default function OrderesList({data}:{data: any}) {
  ...
  return (
    ...
    <div className="sm:flex sm:justify-between sm:items-center mb-8">
      {/* Left: Title */}
        <h1 className="mb-4 sm:mb-0 text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
          Reservas
        </h1>
