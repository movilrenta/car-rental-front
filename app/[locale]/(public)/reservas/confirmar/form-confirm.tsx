...
import {
  getReservaSchema,
  ReservaFormValues,
} from "@/components/schemas/reservas";
...
export const FormConfirm = () => {
  ...
  const preT = useTranslations("ReservaPage.ConfirmarPage");
  ...
  return (
    <div className="w-full md:px-4">
      <h2 className="text-xl md:text-2xl text-gray-900 dark:text-slate-100">
        {preT("subtitleForm.title")}
        <span className="font-bold"> {preT("subtitleForm.span")}</span>
      </h2>
      <div className="-mt-1 mb-4 text-xs">{preT("subtitleForm.mandatory")}</div>
      <Form {...form}>
        <form
